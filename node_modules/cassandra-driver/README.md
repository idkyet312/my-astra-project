...
The driver supports both [promises and callbacks][doc-promise-callback] for the asynchronous
methods,
...
The `#stream()` method works in the same way but instead of callback it returns
